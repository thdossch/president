...
Het probleem met een uitgebreide state, en dus een grote Q-table, is dat het moeilijk is om alle delen te exploreren. In het geval van presidenten komt er dan nog bij dat er delen van de tabel nauwelijks bezocht worden. Methodes met een grote Q-table zijn dus niet geschikt voor een spel als presidenten. Meer info over de uitgebreide state is te vinden in \ref{appendix:extended_state}.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.40]{images/gamma-iteratie-dqn.png}
...
\begin{figure}[H]
    \centering
    \subfloat[tegen random spelers]{{\includegraphics[width=7cm]{images/gamma_bigdqn_20k.png}} }
    \qquad
    \subfloat[tegen heuristieke spelers]{{\includegraphics[width=7cm]{images/gamma_bigdqn_100k.png}} }
...
\begin{figure}[H]
    \centering
    \subfloat[tegen random spelers]{{\includegraphics[width=7cm]{images/lr-iteration-random-big-dqn.png}} }
    \qquad
    \subfloat[tegen heuristieke spelers]{{\includegraphics[width=7cm]{images/lr-iteration-heur-big-dqn.png}} }
